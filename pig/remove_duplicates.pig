...
reviews_hashed = foreach reviews generate product_id, title, price, user_id, profile_name, helpfulness, score, time, summary, text, (text is null ? '' : MD5(text)) as text_hash;
